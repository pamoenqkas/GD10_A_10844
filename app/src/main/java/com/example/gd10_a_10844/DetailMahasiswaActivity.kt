package com.example.gd10_a_10844
...
import com.example.gd10_a_10844.databinding.ActivityDetailMahasiswaBinding
   ...
   private val listMahasiswa = ArrayList<MahasiswaData>()
    ...
    fun deleteData(nim:String){
        ...
        builder.setMessage("Anda yakin mau hapus?? saya ngga yakin loh")
            .setCancelable(false)
            .setPositiveButton("Ya, hapus saja!"){dialog, id-> doDeleteData(nim)}
